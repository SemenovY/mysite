...
class PostAdmin(admin.ModelAdmin):
    ...
    # При вводе заголовка нового поста поле slug заполняется автоматически данными, вводимыми в поле title
    ...
    # По умолчанию посты упорядочены по столбцам STATUS (Статус) и PUBLISH (Опубликован)
